...
<?php require_once 'menu.php'; ?>
          ...
          <div class="content-wrapper">
            ...
            <div class="alert">
                <div>
						<span class="fs-4 font-weight-bold ms-2 me-2">Aviso!</span>
						<p class="font-weight-bold ms-2 me-2">Os nossos modelos de carta estão disponíveis através do download direto da lista abaixo, no formato Word (doc) e Excel(xlsx) e são regularmente atualizados de acordo com a legislação vigente.</p>
                        <p class="font-weight-bold ms-2 me-2">Os seguintes modelos devem ser usados de acordo com os termos e condições e com a lei. A HomeFinder não é responsável pelo uso direto ou indireto desses modelos de maneiras que não são permitidas por lei ou por quaisquer alterações feitas pelo utilizador. Esses documentos são apenas versões simplificadas e não modelos personalizados. Esses modelos não substituem o conselho de um advogado.</p>
                        <!-- <h3 class="title-form text-center">Minutas</h3> -->
                        </div>
                        <hr style="height: 5px; color: #2FCB6A;">
                        <div class="well">        
<h4 class="sub-header">Modelos de arrendamento e inventário</h4>
<ul class="unstyled">
...
<h4 class="sub-header">Para os proprietários</h4>
