            ...
            <table class="table table-hover table-bordered dataTable mt-3">
              <thead>
                <tr>
                  ...
                  <th class="hidden-phone sorting"><a href="/landlord/#buildings/?sort=BuildingComments|"> Tipo Intervenção</a></th>
              ...
              <tbody>
                    ...
                    <div class="noresult">
                      ...
                      <p>Nesta página pode consultar as intervenções do seu imóvel.</p>
                    </div>
                    <p><button type="button" onclick="window.location.href='/landlord/#buildings/new';" class="btn btn-success">Nova Intervenção</button></p>
                  </td>
                </tr>
                  </tbody>
              <tfoot>
